...
const SECTION_CONFIG = {
  'intro': {
    ...
    color: '#8B5CF6',
    pexelsImage: '/img/external/pexels-photo-5905708-55a9e9.jpeg',
    hasImage: true,
  },
  'study': {
    id: 'flash-cards',
    label: 'Flash Cards',
    color: '#3B82F6',
    pexelsImage: '/img/external/books-bookstore-book-reading-159711-5a1445.jpeg',
    hasImage: true,
  },
  'speedmatch': {
    id: 'speed-match',
    label: 'Speed Match',
    color: '#10B981',
    pexelsImage: '/img/external/pexels-photo-13633156-58dc8d.jpeg',
    hasImage: true,
  },
  'practice': {
    id: 'writing',
    label: 'Writing',
    color: '#F59E0B',
    pexelsImage: '/img/external/pexels-photo-210661-e9ef22.jpeg',
    hasImage: true,
  },
  'pronunciation': {
    id: 'pronunciation',
    label: 'Pronunciation',
    color: '#EF4444',
    pexelsImage: '/img/external/pexels-photo-164960-125a3e.jpeg',
    hasImage: true,
  },
  'conversation': {
    id: 'conversation',
    label: 'Conversation',
    color: '#06B6D4',
    pexelsImage: '/img/external/pexels-photo-3184291-c313e0.jpeg',
    hasImage: true,
  },
};
