...
export const vocabularySummary = {
  ...
  "units": [
    ...
    },
    {
      ...
      "description": "B2 Level Phrases! Learn special verb forms, then use them in top practical expressions: necessity (il faut que), wishes (je veux que), emotions (je suis content que), hypotheticals (si j'étais...), regrets (si j'avais su), services (je me fais couper), and more!",
      "icon": "🎓",
      "color": "#8b5cf6",
      "totalVocabulary": 216,
      "moduleCount": 17
