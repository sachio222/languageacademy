...
import { pronunciationTest } from "./pronunciation-test.js";
...
export const referenceConfig = {
  ...
  modules: [
    ...
    pronunciationTest, // 164. Pronunciation Test - AI-powered pronunciation practice
    cognatesHelpModule, // 165. Cognates Help - French and English Share Many Words
    liaisonHelpModule, // 166. Liaison Help - French Flow
    verbPatternHelp, // 167. Understanding Verb Patterns
  ],
};
