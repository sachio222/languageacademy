  ...
  exerciseConfig: {
    ...
    items: [
      ...
      },
      {
        ...
        acceptableAnswers: ["meilleur", "meilleur restaurant"],
        wrongAnswers: [],
      },
      {
      ...
      },
      {
        ...
        acceptableAnswers: ["pizza", "pain eau et pizza", "une pizza"],
        wrongAnswers: [],
      },
      {
        ...
        acceptableAnswers: ["express", "café"],
        wrongAnswers: [],
      },
      {
      ...
      },
      {
        ...
        acceptableAnswers: ["meilleure", "pizza"],
        wrongAnswers: [],
      },
      {
      ...
      },
      {
        ...
        expectedAnswer: "nous ne pouvions pas",
        acceptableAnswers: [
          "pouvions",
          "ne pouvions pas",
      ...
      },
      {
        ...
        hint: "The same",
        expectedAnswer: "le même restaurant",
        acceptableAnswers: ["même"],
        wrongAnswers: [],
      },
      {
        ...
        expectedAnswer: "tu devrais aller",
        acceptableAnswers: ["devrais", "tu devrais", "je devrais aller"],
        wrongAnswers: [],
      },
      {
        ...
        expectedAnswer: "tu pourrais manger",
        acceptableAnswers: ["pourrais", "tu pourrais", "je pourrais manger"],
        wrongAnswers: [],
      },
    ],
  },
