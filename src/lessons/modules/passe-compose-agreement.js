...
export const passeComposeAgreementModule = {
  ...
  vocabularyReference: [
    ...
    },
    {
      ...
      english: "we went",
      agreement: "all feminine plural (+es)",
      example: "Marie et moi (both girls), nous sommes allées",
    },
    {
