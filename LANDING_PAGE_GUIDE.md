...
✅ **Grayscale + one accent:** Uses #1a1a1a, #665665, #999999 + #3b82f6 blue  
...
**Key Insight:** You're selling **methodology** to **analytical learners**. They want to understand _how_ it works before committing. The landing page gives them that understanding, then asks for commitment.
