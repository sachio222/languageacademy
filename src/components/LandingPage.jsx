  ...
  return (
    <div className="landing-page">
      ...
      <section className="landing-section bg-subtle-alt">
        <div className="landing-container">
          {/* CHOOSE YOUR ABSURD ILLUSTRATION */}
          <div style={{display: 'flex', gap: '2rem', justifyContent: 'center', marginBottom: '3rem', flexWrap: 'wrap'}}>
            
            {/* OPTION 1: Stacked Books Tower */}
            <div style={{textAlign: 'center'}}>
              <div style={{fontSize: '0.75rem', fontWeight: '600', color: '#665665', marginBottom: '0.5rem'}}>OPTION 1: Book Tower</div>
            ...
            {/* OPTION 2: Brain Lightning Zap */}
            <div style={{textAlign: 'center'}}>
              <div style={{fontSize: '0.75rem', fontWeight: '600', color: '#665665', marginBottom: '0.5rem'}}>OPTION 2: Brain Zap</div>
              <div className="section-illustration">
                <svg viewBox="0 0 200 200" fill="none">
                  <circle cx="100" cy="100" r="85" fill="#3b82f6" opacity="0.06"/>
            ...
            {/* OPTION 3: Growing Plant/Tree */}
            <div style={{textAlign: 'center'}}>
              <div style={{fontSize: '0.75rem', fontWeight: '600', color: '#665665', marginBottom: '0.5rem'}}>OPTION 3: Growth</div>
              <div className="section-illustration">
                <svg viewBox="0 0 200 200" fill="none">
                  <circle cx="100" cy="100" r="85" fill="#3b82f6" opacity="0.06"/>
            ...
            {/* OPTION 4: Balancing Act */}
            <div style={{textAlign: 'center'}}>
              <div style={{fontSize: '0.75rem', fontWeight: '600', color: '#665665', marginBottom: '0.5rem'}}>OPTION 4: Balance</div>
              <div className="section-illustration">
                <svg viewBox="0 0 200 200" fill="none">
                  <circle cx="100" cy="100" r="85" fill="#3b82f6" opacity="0.06"/>
            ...
            {/* OPTION 4: Messy Workshop/Toolkit */}
            <div style={{textAlign: 'center'}}>
              <div style={{fontSize: '0.75rem', fontWeight: '600', color: '#665665', marginBottom: '0.5rem'}}>OPTION 4: Workshop</div>
              <div className="section-illustration">
                <svg viewBox="0 0 200 200" fill="none">
                  <circle cx="100" cy="100" r="85" fill="#3b82f6" opacity="0.06"/>
