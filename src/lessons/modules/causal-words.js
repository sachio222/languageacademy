  ...
  vocabularyReference: [
    {
      french: "parce que",
      english: "because",
      usage: "+ clause (subject + verb)",
      position: "middle or end of sentence",
    },
    {
      french: "car",
      english: "for, because",
      usage: "+ clause (subject + verb)",
      position: "middle of sentence only (never at start!)",
    },
    {
      french: "puisque",
      english: "since, seeing as",
      usage: "+ clause (subject + verb)",
      position: "start or middle of sentence",
    },
    {
      french: "comme",
      english: "as, since",
      usage: "+ clause (subject + verb)",
      position: "START of sentence only!",
    },
    {
      french: "grâce à",
      english: "thanks to",
      usage: "+ NOUN (not a clause!)",
      position: "start or middle of sentence",
    },
    {
      french: "à cause de",
    ...
    },
    {
      french: "pourquoi",
      english: "why",
      usage: "question word - answered by 'parce que'",
      position: "start of question",
    },
    {
      french: "la raison",
      english: "the reason",
