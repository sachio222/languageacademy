 ...
 * Contains 2018 unique translations
 *
 * ⚠️  IMPORTANT: KEEP THIS FILE ALPHABETICALLY SORTED ⚠️
 *
 * HOW TO ADD NEW WORDS:
 *
 * 1. Search first (Cmd/Ctrl+F) - the word might already exist
 *
 * 2. Add in alphabetical position:
 *    Example: To add 'maintenant', scroll to the M section and insert it
 *    between 'main' and 'maison'
 *
 * 3. Format: 'french': 'english translation',
 *    - Use lowercase for keys (unless proper noun)
 *    - Multiple meanings: 'word': 'meaning 1 / meaning 2'
 *    - Keep the comma at the end (except last entry)
 *
 * 4. Auto-sort if needed:
 *    Run: npm run vocab:sort
 *
 * 5. Validate (optional):
