/**
 * Wikipedia Entries for Reading Passages
 *
 * Contains Wikipedia data for French places, people, and cultural references
 * that appear in reading passages. Used to provide rich tooltips with images
 * and descriptions when users hover over these terms.
 */

export const wikipediaEntries = {
