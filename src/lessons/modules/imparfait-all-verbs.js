  ...
  vocabularyReference: [
    {
      ...
      formation: "nous parlons → parl- → parlais",
      example: "Je parlais français tous les jours",
    },
    {
      french: "il faisait",
      english: "it was (weather) / he was doing",
      formation: "nous faisons → fais- → faisait",
      example: "Il faisait beau",
    },
    {
      french: "on allait",
      english: "we were going / we used to go",
      formation: "nous allons → all- → allait",
      example: "On allait au café chaque samedi",
    },
    {
      french: "je voulais",
      english: "I wanted / I was wanting",
      formation: "nous voulons → voul- → voulais",
      example: "Je voulais partir",
    },
    {
      french: "il y avait",
      english: "there was / there were",
      formation: "nous avons → av- → avait",
      example: "Il y avait beaucoup de gens",
    },
    {
      french: "je prenais",
      english: "I was taking / I used to take",
      formation: "nous prenons → pren- → prenais",
      example: "Je prenais le bus tous les jours",
    },
    {
      french: "nous étions",
      english: "we were",
      formation: "être (irregular) → ét- → étions",
      example: "Nous étions contents",
    },
    {
      french: "tous les jours",
      english: "every day",
      usage: "time expression for habits",
      example: "Je travaillais tous les jours",
    },
    {
      french: "chaque",
      english: "each, every",
